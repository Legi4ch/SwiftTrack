...
<body>
    ...
    <div class="container">
      ...
      <div class="row center">
        <h5 class="header col s12 light">
            Swift Track был создан для решения задач. И мы знаем, что вам нужно!
        </h5>
      </div>
      <br><br>
      ...
      <div class="row">
          <div class="col l12">
              ...
              <p class="blue-grey-text">
                  ...
                  и запрашивайте данные из базы проекта. Swift Track работает со всеми методами маршрутов GET, POST,  PUT, DELETE, OPTION.
              </p>
              <p class="blue-grey-text">
              ...
              <p class="blue-grey-text">
                  ...
                  Что-то идет не так? Правки будут очень быстрыми. А благодаря простой архитектуре Swift Track, Вы легко смените фреймворк на другой, когда
  ...
  <div class="container">
      <div class="row">
          <div class="col l12">
              <h4 class="header light-blue-text lighten-1">Как устроен Swift Track?</h4>
              <p class="blue-grey-text">
              ...
              <p class="blue-grey-text">
                  ...
                  Swift Track не содержит полноценного встроенного шаблонизатора, и это но не случайно!
                  ...
                  повторяющийся код шаблонов везде, где требуется. Swift Track не рекомендует выносить логику приложения в шаблоны html. Она должна оставаться в контроллерах и моделях!


              </p>
              <p class="blue-grey-text">
                  При разработке Swift Track во главе угла стояла идея о максимально быстром запуске приложения, чтобы можно было сосредоточиться на отдельных
              ...
              <p class="blue-grey-text">
              <blockquote>
                  Мы убеждены, что самым лучшим способом Вашего знакомства будет установка Swift Track и запуск первого приложения!
                  Посмотрев демо сайт поставляемый вместе с фреймворком, Вы легко разберетесь как работать с Swift Track, даже если Вы не слишком
              ...
              <p class="blue-grey-text">
                  ...
                  Содержит файлы контроллеров. В Swift Track все завязано на контроллеры, которые являются наследниками от абстрактного класса <i>BaseController</i>.
                  ...
                  разработчика и не реализован в Swift Track.
              </p>
              <p class="blue-grey-text">
              ...
              <p class="blue-grey-text">
                  ...
                  Swift Track позволяет разделять запросы к маршрутам по http методам и внедрять обработчики промежуточного слоя в маршруты. Это позволяет быстро

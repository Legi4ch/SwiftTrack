    ...
    <div class="container">
      ...
      <div class="row center">
        <h5 class="header col s12 light">
            Swift Track был разработан с акцентом на минимализм и эффективность,
      ...
      <div class="row">
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <p class="light">
                С Swift Track вы можете начать работу практически мгновенно.
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <p class="light">
                Swift Track идеальный инструмент для небольших и средних проектов,
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <p class="light">
                ...
                Swift Track предлагает всего несколько базовых сущностей, которые вам точно понадобятся.
            </p>
          </div>
        </div>
      </div>

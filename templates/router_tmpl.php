      ...
      <div class="row">
          <div class="col l12">
              ...
              <p class="blue-grey-text">
                  Под маршрутом в SwiftTrack следует понимать URL адрес страницы Вашего сайта, который определяет состояние приложения.<br/><br/>
              ...
              <p class="blue-grey-text">
                  Точкой доступа в приложение SwiftTrack является файл <i>index.php</i>, расположенный в корне Вашего проекта.<br/>
...
return function (Router $router) {
    ...
    $router->post("/setData", "app\Controllers\getDataController");
              ...
              <p class="blue-grey-text">
                  ...
                  Все контроллеры SwiftTrack являются наследниками абстрактного класса <span class="method">App/BaseController</span>.
...
$router->get("/account", "app\Controllers\AccountController", [new AuthMiddleware()]);
              ...
              <p class="blue-grey-text">
                  ...
                  SwiftTrack позволяет использовать регулярные выражения в маршрутах для решения этой задачи.
<pre>
